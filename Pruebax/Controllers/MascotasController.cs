...
namespace Pruebax.Controllers
{
    public class MascotasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre")] Mascota mascota)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var mascota = await _context.Mascotas.SingleOrDefaultAsync(m => m.Id == id);
            if (mascota == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] Mascota mascota)
        {
            if (id != mascota.Id)
            {
                return NotFound();
